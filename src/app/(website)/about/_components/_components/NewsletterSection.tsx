...
const NewsletterSection = () => {
  return (
    <div className="relative mx-auto mt-[100px] flex h-[auto] min-h-[569px] w-full items-center justify-center">
      ...
      <div
        className="absolute z-10 lg:w-full w-[90%]  md:w-1/2 max-w-[670px] lg:max-h-[293px] rounded-lg bg-gradient-to-r from-[#FDFDFD40] to-[#200C0D] bg-opacity-100 p-4 md:p-10 lg:left-[5%] lg:top-[15%]"
      >
