...
const formSchema = z.object({
    ...
    issueDetails: z.string().min(10, "Issue details must be at least 10 characters"),
    file: z.any().optional(),
})
    ...
    return (
        <div className="w-full max-w-full mx-auto p-4 sm:p-6">
            <div className="text-center mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-white">Raise New Ticket</h1>
            </div>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 max-w-full">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm flex">Subject <Star className="text-red-500 h-2 mt-1" fill="currentColor" /></FormLabel>
                                <FormControl>
                                    <Input
                                        placeholder="Enter subject name"
                                        className="w-full h-12 border-gray-600  text-white placeholder:text-gray-400 focus:border-gray-500"
                                        {...field}
                                    />
                                </FormControl>
                                <FormMessage />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm flex">Name <Star className="text-red-500 h-2 mt-1" fill="currentColor" /></FormLabel>
                                <FormControl>
                                    <Input
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm flex">Service <Star className="text-red-500 h-2 mt-1" fill="currentColor" /></FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <SelectContent className=" border-gray-600 bg-black">
                                        ...
                                        {userSubscriptions?.map((service: any) => (
                                            <SelectItem key={service._id} value={service?.services[0]?.serviceId?._id} className="text-white hover:bg-gray-700 ">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm">Urgency</FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    <FormControl>
                                        <SelectTrigger className="w-full border-gray-600  text-white focus:border-gray-500">
                                            <SelectValue />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm">Envato Purchase Key</FormLabel>
                                <FormControl>
                                    <Input
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-white text-sm">Issue Details</FormLabel>
                                <FormControl>
                                    <Textarea
                                        placeholder="Write here..."
                                        className="w-full min-h-[120px] border-gray-600  text-white placeholder:text-gray-400 focus:border-gray-500 resize-none"
                                        {...field}
                                    />
                                </FormControl>
                                <FormMessage />
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            {selectedFile && <span className="text-gray-400 text-sm self-center">{selectedFile.name}</span>}
                        </div>
                    </div>
